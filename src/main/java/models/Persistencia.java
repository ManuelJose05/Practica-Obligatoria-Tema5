...
public class Persistencia implements Serializable {
    ...
    public static ArrayList<User> loadUser() {
        ...
        try {
            if (Objects.requireNonNull(f.list()).length != 0 && f.exists()){
    ...
    public static ArrayList<Shipment> loadShipmentToAssign() {
        ...
        try {
            if (Objects.requireNonNull(f.listFiles()).length != 0 && f.exists()) {
    ...
    public static void newShipmentLog(Shipment shipment) {
        try {
            BufferedWriter bw = new BufferedWriter(new FileWriter(Config.logPath() + "/log.txt", true));
            if (shipment != null)
    ...
    public static void updateShipmentLog(Shipment shipment) {
        try {
            BufferedWriter bw = new BufferedWriter(new FileWriter(Config.logPath() + "/log.txt", true));
            if (shipment != null)
